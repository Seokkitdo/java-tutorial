...
public class D_Switch {
	...
	public void method2() {
		...
		case "키위":
			...
			break;
		default:
			System.out.println("그 과일은 신우네 과일가게에는 없습니다ㅠㅠ 옆에 신우마트로 가보세요!");
		}
		System.out.printf(fruit + "의 가격은 " + price + "원입니다");
	}
...
//			break;
//		default:
//			System.out.println("1부터 12까지만 입력해주세요.");
//		}
		...
		default:
			System.out.println("1부터 12 사이의 숫자를 입력하세요.");
		}
	}
